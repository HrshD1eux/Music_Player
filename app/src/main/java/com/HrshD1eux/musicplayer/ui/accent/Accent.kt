 ...
 * Accent.kt is part of Music Player.
 *
...
package com.HrshD1eux.musicplayer.ui.accent
...
private val accentThemes =
    intArrayOf(
        R.style.Theme_MusicPlayer_Red,
        R.style.Theme_MusicPlayer_Pink,
        R.style.Theme_MusicPlayer_Purple,
        R.style.Theme_MusicPlayer_DeepPurple,
        R.style.Theme_MusicPlayer_Indigo,
        R.style.Theme_MusicPlayer_Blue,
        R.style.Theme_MusicPlayer_DeepBlue,
        R.style.Theme_MusicPlayer_Cyan,
        R.style.Theme_MusicPlayer_Teal,
        R.style.Theme_MusicPlayer_Green,
        R.style.Theme_MusicPlayer_DeepGreen,
        R.style.Theme_MusicPlayer_Lime,
        R.style.Theme_MusicPlayer_Yellow,
        R.style.Theme_MusicPlayer_Orange,
        R.style.Theme_MusicPlayer_Brown,
        R.style.Theme_MusicPlayer_Grey,
        R.style.Theme_MusicPlayer_App, // Dynamic colors are on the base theme
    )

private val accentBlackThemes =
    intArrayOf(
        R.style.Theme_MusicPlayer_Red_Black,
        R.style.Theme_MusicPlayer_Pink_Black,
        R.style.Theme_MusicPlayer_Purple_Black,
        R.style.Theme_MusicPlayer_DeepPurple_Black,
        R.style.Theme_MusicPlayer_Indigo_Black,
        R.style.Theme_MusicPlayer_Blue_Black,
        R.style.Theme_MusicPlayer_DeepBlue_Black,
        R.style.Theme_MusicPlayer_Cyan_Black,
        R.style.Theme_MusicPlayer_Teal_Black,
        R.style.Theme_MusicPlayer_Green_Black,
        R.style.Theme_MusicPlayer_DeepGreen_Black,
        R.style.Theme_MusicPlayer_Lime_Black,
        R.style.Theme_MusicPlayer_Yellow_Black,
        R.style.Theme_MusicPlayer_Orange_Black,
        R.style.Theme_MusicPlayer_Brown_Black,
        R.style.Theme_MusicPlayer_Grey_Black,
        R.style.Theme_MusicPlayer_Black, // Dynamic colors are on the base theme
    )
