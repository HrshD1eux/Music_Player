 ...
 * ErrorDetailsDialog.kt is part of Music Player.
 *
...
import com.HrshD1eux.musicplayer.databinding.DialogErrorDetailsBinding
...
class ErrorDetailsDialog : ViewBindingMaterialDialogFragment<DialogErrorDetailsBinding>() {
    ...
    private companion object {
        ...
        const val LINK_ISSUES =
            "https://github.com/HrshD1eux/Music_Player/issues/new" +
                "?assignees=HrshD1eux&labels=bug&projects=&template=bug-crash-report.yml"
    }
}
