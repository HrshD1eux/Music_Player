 ...
 * IntegerTable.kt is part of Music Player.
 *
...
object IntegerTable {
    ...
    /** Activity MusicPlayerService Start ID */
    const val START_ID_ACTIVITY = 0xA050
    /** Tasker MusicPlayerService Start ID */
    const val START_ID_TASKER = 0xA051
    /** MediaButtonReceiver MusicPlayerService Start ID */
