 ...
 * BasePreferenceFragment.kt is part of Music Player.
 *
...
import com.HrshD1eux.musicplayer.settings.ui.PreferenceHeaderItemDecoration
...
abstract class BasePreferenceFragment(@XmlRes private val screen: Int) :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<MusicPlayerToolbar>(R.id.preferences_toolbar).apply {
