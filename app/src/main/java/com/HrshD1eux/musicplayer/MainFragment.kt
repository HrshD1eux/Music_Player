 ...
 * MainFragment.kt is part of Music Player.
 *
...
package com.HrshD1eux.musicplayer
...
import com.HrshD1eux.musicplayer.home.Outer
...
import com.HrshD1eux.musicplayer.playback.OpenPanel
import com.HrshD1eux.musicplayer.playback.PlaybackBottomSheetBehavior
import com.HrshD1eux.musicplayer.playback.PlaybackViewModel
import com.HrshD1eux.musicplayer.playback.queue.QueueBottomSheetBehavior
import com.HrshD1eux.musicplayer.ui.DialogAwareNavigationListener
    ...
    private fun forceHideAllFabs() {
        ...
        if (binding.homeNewPlaylistFab.mainFab.isOrWillBeShown) {
            try {
                ...
                binding.homeNewPlaylistFab.mainFab.hide()
            }
        }
    }
