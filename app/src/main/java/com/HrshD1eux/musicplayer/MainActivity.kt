 ...
 * MainActivity.kt is part of Music Player.
 *
    ...
    override fun onResume() {
        ...
        startService(
            Intent(this, MusicPlayerService::class.java)
                ...
                .putExtra(MusicPlayerService.INTENT_KEY_START_ID, IntegerTable.START_ID_ACTIVITY)
        )
    ...
    private fun startIntentAction(intent: Intent?): Boolean {
        ...
        val action =
            when (intent.action) {
                ...
                MusicPlayerApp.INTENT_KEY_SHORTCUT_SHUFFLE -> DeferredPlayback.ShuffleAll
                else -> {
